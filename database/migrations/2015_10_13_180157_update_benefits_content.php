...
class UpdateBenefitsContent extends Migration
{
	...
	public function up()
	{
		...
		Benefit::find(2)->update([
				'title'			=> 'Networking',
				'text'			=> '<p>Networking and the sharing of information is what really makes our events worthwhile. Many of our peers have faced similar challenges to ones that you may currently be working with. Being able to sit down and talk with them, one on one, about their experiences, what worked and what did not, can provide valuable insight into finding a solution that will work with your current challenge, task or situation.</p>',
			]);
		...
		Benefit::find(5)->update([
				'title'			=> 'Our Partners',
				'text'			=> '<p>We work to align ourselves with local IT support groups, user groups and IT professionals in each region who are dedicated to promoting IT within the local community.  These groups are often non-profit organizations that are working to promote IT within the local community through the sharing of knowledge and information and educational scholarships; thus building our next generation of IT professionals.</p>',
			]);
